...
class ImagesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', function ($query) {
            return '<a href="images/'.$query->id.'/edit" class="btn btn-success edit"><i class="fa fa-edit"></i></a>';
        })
        ->addColumn('show', function ($query) {
            return '<a href="images/'.$query->id.'" class="btn btn-info"><i class="fa fa-search" aria-hidden="true"></i>  </a>';
        })

        ->addColumn('delete', 'admin.pages.images.btn.delete')
        ->addColumn('image', function ($query) {
            $url= asset($query->image);
            if ($query->image != null) {
                return '<img src="' . $url . '" border="0" width="40" class="img-rounded" align="center" style="width:140px" />';
            }else{
                return '<img src="'.asset('/').'assets/default.png" class="profile-user-img img-responsive img-circle" style="width:140px" alt="User Image">';
            }
        })
        ->addIndexColumn()
        ->rawColumns([
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons' => [
                    [
                        'text' => '<i class="fa fa-five"></i> ' . trans('admin.add_images'),
