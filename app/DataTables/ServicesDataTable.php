    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                return '<a href="services/'.$query->id.'/edit" class="btn btn-success edit"><i class="fa fa-edit"></i></a>';
            })
            ->addColumn('show', function ($query) {
                return '<a href="services/'.$query->id.'" class="btn btn-info"><i class="fa fa-search" aria-hidden="true"></i>  </a>';
            })

            ->addColumn('delete', 'admin.setting.service.btn.delete')
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons' => [
                    [
                        'text' => '<i class="fa fa-five"></i> ' . trans('admin.add_service'),
