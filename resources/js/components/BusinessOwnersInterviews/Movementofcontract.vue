        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input disabled style="background:yellow" class="form-control" :value="company != '' ? companies[0].name_ar : ''" type="text" name="" id="company">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input disabled style="background:yellow" v-model="form.move_number" class="form-control" type="text" name="" id="movementnumber">
...
export default {
    ...
    methods:{
        ...
        companyform:function(){
            ...
            axios.get('api/admin/datarecoverycontract/'+ this.employer +'/'+ this.company).then((response)=>{
                if (response.data[0] != '') {
                    ...
                    this.form.move_number = this.branch * 100000 + Number(response.data[1]) + 1
