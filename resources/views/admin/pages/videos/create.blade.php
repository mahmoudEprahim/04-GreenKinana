        ...
        $(document).ready(function () {
            $('#appendSubCat').click(function (e) {
                ...
                <div class="form-group" >
                    <div class="row">
                        <div class="col-md-4">
                            <label for="video link in home page" class="control-label">Video Link In Home Page</label>
                            <input id="video link in home page" name="video_src[]" type="text" class="form-control">
                        </div> 
                        <div class="col-md-4">
        ...
        <div class="appendDiv">
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    ...
                    {{ Form::text('video_src[]',null, array_merge(['id'=>'video link in home page','class' => 'form-control'])) }}
                </div>
